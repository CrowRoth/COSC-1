...
public class RollTwoPairs {
    ...
    public static void main(String[] args) {
        ...
        do {  // Roll the two pairs of dice until totals are the same.
            ...
            total1 = firstDice.getTotal();   // Get total.
            System.out.println("First pair comes up  " + firstDice + " which adds up to: " + total1);

            secondDice.roll();    // Roll the second pair of dice.
            total2 = secondDice.getTotal();   // Get total.
            System.out.println("Second pair comes up " + secondDice + " which adds up to: " + total2);
